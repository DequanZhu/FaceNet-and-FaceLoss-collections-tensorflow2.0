...
class LarginAngularLinear(layers.Layer):
    def __init__(self, units, input_dim, margin):
        super(LarginAngularLinear, self).__init__()
        self.m = margin  # m
        self.beta = 1000
        self.beta_min = 0
        self.decay = 0.99
...
class SphereFaceLinear(layers.Layer):
    def __init__(self, units, input_dim, margin, beta = 1000, beta_min=0, decay=0.99,feature_norm=True):
        super(SphereFaceLinear, self).__init__()
        self.m = margin  # m
...
class AdditiveMarginLinear(layers.Layer):
